...
ggplot(fit_data) + 
  ...
  geom_line(aes(x=population,y=kocsma_predict_ols)) +
  geom_line(aes(x=population,y=kocsma_predict_nls),color='red') +
  scale_x_log10() +
  scale_y_log10() 
```
...
ggplot(fit_data) + 
  ...
  geom_line(aes(x=population,y=kocsma_predict_ols)) +
  geom_line(aes(x=population,y=kocsma_predict_nls),color='red') +
  geom_line(aes(x=population,y=kocsma_predict_mle),color='blue') +
  scale_x_log10() +
  scale_y_log10() 
